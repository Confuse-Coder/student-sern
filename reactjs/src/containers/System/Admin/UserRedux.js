...
class UserRedux extends Component {
  ...
  handleEditUserFromParent = (user) => {
    ...
    this.setState(
      ...
      () => {
        console.log('Console Base64,', this.state);
      }
    );
  };
  ...
  render() {
    ...
    return (
      <div className="user-redux-container">
        <div className="title">Learn React-Redux Huỳnh Thanh Tú from Channel Youtube</div>
